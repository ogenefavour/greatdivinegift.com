...
class Admin{
    ...
    //get total number of courses a class offers
    public function getScores($conn,$subjectid,$studentid,$termid){
        $sqlsubsco = "SELECT  subject_id,total_score FROM result WHERE student_id = '$studentid' AND subject_id = '$subjectid' AND term_id ='$termid'";
    ...
    public function totalAverage($conn,$totalscore,$classid,$sessionid,$termid){
//        if($classid<=3){
//            $count = 11;
...
//        }
        if($classid>4 && $classid != 14){
            ...
            $count = $this->getSubjectCount2($conn,$classid,$sessionid,$termid);
        }    
    ...
    public function formTeacher($classid){
        switch ($classid) {
            ...
            case 2:
                ...
                break;
            case 3:
                $name = 'Miss M.Francisca';
                break;
            case 4:
                $name = 'Mr. Chukwunonso Samuel';
                break;
            case 14:
                $name = 'Mr. Chukwunonso Samuel';
                break;
            case 5:
                $name = 'Miss Nwachukwu Chioma';
                break;
            case 6:
