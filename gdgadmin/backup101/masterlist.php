                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    while($row = mysqli_fetch_assoc($result1)){ 
                                        ...
                                        if(!$schooladmin->getScores($conn,$subjectid,$studentid,$termid) == NULL){
                                            echo "<td class='text-center'> {$schooladmin->getScores($conn,$subjectid,$studentid,$termid)} </td>";
                                        }else{
...
//                                        
                                    ...
                                    <?php // if($classid<=3){echo round($schooladmin->getTotalMark($conn, $studentid,$classid,$sessionid,$termid)/11,2);
                                      //  if($classid<=3){echo round($schooladmin->getTotalMark($conn, $studentid,$classid,$sessionid,$termid)/$schooladmin->getSubjectCount2($conn, $studentid,$classid,$sessionid,$termid),2);
...
//                                          }
                                        if($classid>4 && $classid != 14){
                                            echo round($schooladmin->getTotalMark($conn, $studentid,$classid,$sessionid,$termid)/9,2);
                                        }else{
                                            echo round($schooladmin->getTotalMark($conn, $studentid,$classid,$sessionid,$termid)/$schooladmin->getSubjectCount2($conn,$classid,$sessionid,$termid),2);
                                        }                                    
                                        ?>
                                    </td>
                                    <td>
