...
//                }
                if(isset($Row[3])) {
                    ...
                    if ($category == 'JSS 1A' || $category == 'JSS1A') {
                        ...
                        $class = 24;
                    }elseif($category == 'SSS 2A' || $category == 'SSS2A'){
                        $class = 5;
                    }elseif($category == 'SSS 2B' || $category == 'SSS2B'){
                        $class = 15;
                    } elseif($category == 'SSS 3A' || $category == 'SSS3A'){
                        $class = 6;
                    }
                }
