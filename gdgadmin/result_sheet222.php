...
echo "<b>". $classid = $schooladmin->getresultClassid($conn,$studentid,$sessionid,$termid)."</b>";
?>
<style>
/*    .school-logo{
        height: 140px;
                    ...
                    <div class="user-block">
                        ...
                        <div class="text-center">
                            ...
                            <h6 class="text-bold"><?php 
                                 if($classid = 11 || $classid =22 || $classid= 13){echo "Abubor Nnewichi , Nnewi"; }else{
                            echo ($schooladmin->schoolAddress($conn, $school_id));
                            }?></h6>
                                   ...
                                   <td class="pull-left"><?php echo $schooladmin->getTotalObtainablemark($conn, $classid,$sessionid,$termid);?></td>          
                                    ...
                                    //if($classid<=3){echo round($schooladmin->getTotalMark($conn, $studentid,$classid,$sessionid,$termid)/11,2);
                                      ...
                                      //    } elseif($classid==4 || $classid==14){echo round($schooladmin->getTotalMark($conn, $studentid,$classid,$sessionid,$termid)/13,2); 
                                        ...
                                        echo round($schooladmin->getTotalMark($conn, $studentid,$classid,$sessionid,$termid)/ $avrg,2);
                                    ...
                                    <td>
                                        ...
                                        while($row= mysqli_fetch_assoc($res)){
                                            ...
                                            // comment out by chisom from here down
                                            ...
                                            // }
                                             ...
                                             //added by chisom for subcount
                                            if($classid==5 || $classid==6 || $classid == 15){                      
                                                 $subcount = 10;
                                           }else{
                                                $subcount=$schooladmin->getSubjectCount2($conn,$classid,$sessionid,$termid);
//                                                $sqlcount2r="SELECT COUNT(DISTINCT subject_id) AS thecount FROM result WHERE class='$classid' AND session_id='$sessionid' AND term_id ='$termid'";
//                                                $result2r=  mysqli_query($conn,$sqlcount2r);
//                                                $row=mysqli_fetch_assoc($result2r);
                ...
                <div class="box-body no-padding">
                    ...
                    <div class="box-footer">
                        <ul class="list-unstyled">
                            <li><b>Form Teacher's Comment:</b> &nbsp; <?php echo $schooladmin->totalAverage($conn,$schooladmin->getTotalMark($conn, $studentid,$classid,$sessionid,$termid),$classid,$sessionid,$termid)?></li>
                            <li><b>Form Teacher Name:</b> 
                            ...
                            <li><b>Name & Signature</b> ENGR. PETER CHUKWUNEMEMMA </li><br>
                             <li><b>Resumption Date for 2nd Term:</b> 6th January 2020</li>
                        </ul>
                    </div>
